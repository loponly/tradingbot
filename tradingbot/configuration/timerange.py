...
class TimeRange:
    """
    object defing timerange inputs.
    ...
    def __eq__(self, other):
        ...
        return (self.starttype == other.starttype
    ...
    def adjust_start_if_necessary(self, timeframe_secs: int,
                                  startup_candles: int,
        ...
        if (not self.starttype
                or (startup_candles and min_date.timestamp >= self.startts)):
