...
class DataProvider:
    def __init__(self,
        ...
        self.__cached_pairs: Dict[PairWithTimeframe, Tuple[DataFrame,
                                                           datetime]] = {}

    def _set_cached_df(self, pair: str, timeframe: str,
        ...
        """
        self.__cached_pairs[(pair, timeframe)] = (dataframe,
    ...
    def ohlcv(self,
        ...
        if self.runmode in (RunMode.DRY_RUN, RunMode.LIVE):
            return self._exchange.klines(
                (pair, timeframe or self._config['timeframe']), copy=copy)
        else:
            return DataFrame()
    ...
    def get_analyzed_dataframe(self, pair: str,
                               timeframe: str) -> Tuple[DataFrame, datetime]:
        """
        :param pair: pair to get the data for
        :param timeframe: timeframe to get data for
