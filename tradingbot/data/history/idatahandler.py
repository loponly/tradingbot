...
from tradingbot.data.converter import clean_ohlcv_dataframe, trades_remove_duplicates, trim_dataframe
from tradingbot.exchange import timeframe_to_seconds
...
class IDataHandler(ABC):
    ...
    def trades_load(self,
        ...
        :return: List of trades
        """
        return trades_remove_duplicates(
    ...
    def _validate_pairdata(self, pair, pairdata: DataFrame,
                           timerange: TimeRange):
        """
...
def get_datahandler(datadir: Path,
